...
import com.thereza.radiosouthern.services.BackgroundSoundService;
import com.thereza.radiosouthern.apputils.DetectConnection;
...
public class MainActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv = this.findViewById(R.id.marquee);
        tv.setSelected(true);
	...
	private void initControls()
    {
        try
        {
            volumeSeekbar = findViewById(R.id.bar);
    ...
    private void Notify(){
		...
		builder.setContentTitle("Radio Player Notification");
        ...
        notificationManager.notify(9999, myNotication);
     }
